...
* **Technical Architecture Deep-Dive:** Read `ARCHITECTURE.md <./ARCHITECTURE.md>`_ to review async connection pooling constraints and mock transport testing architecture.
